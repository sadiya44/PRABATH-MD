...
export const YoutubeDownloadBaseUrl = "https://backendpro.myconverters.com";
export const KomikuIdBaseUrl = "https://komiku.id";
export const AnoboyBaseUrl = "https://anoboy.ink";
export const StatusWaIndonesiaBaseUrl = "https://www.videostatusmarket.com";
export const UnsplashBaseUrl = "https://api.unsplash.com";
export const InstagramDownloadBaseUrl = { v1: "https://igram.bar", v2: "https://indown.io" };
export const TiktokDownloadRapidApiServer = "https://tiktok-video-no-watermark2.p.rapidapi.com";
export const DanbooruBaseUrl = "https://danbooru.donmai.us";
export const FacebookDownloadBaseUrls = {
...
export const PinterestDownloadBaseUrls = {
