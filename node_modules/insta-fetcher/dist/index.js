...
class igApi {
    ...
    constructor(IgCookie = '', AxiosOpts = {}) {
        ...
        this.fetchPostByShortcode = (shortcode) => __awaiter(this, void 0, void 0, function* () {
            const res = yield this.FetchIGAPI(config_1.config.instagram_base_url, '/graphql/query/', config_1.config.iPhone, { params: (0, query_1.post_shortcode_query)(shortcode) });
